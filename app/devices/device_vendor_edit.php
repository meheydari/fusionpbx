...
//show the content
	...
	echo button::create(['type'=>'button','label'=>$text['button-save'],'icon'=>$_SESSION['theme']['button_icon_save'],'id'=>'btn_save','style'=>'','onclick'=>"document.getElementById('frm').submit();"]);
	echo "	</div>\n";
