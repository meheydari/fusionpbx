...
//begin the page content
	...
	if ($action == 'update') {
		...
		if (permission_exists('xml_cdr_view')) {
			echo button::create(['type'=>'button','label'=>$text['button-cdr'],'icon'=>'info-circle','style'=>(''),'link'=>'../xml_cdr/xml_cdr.php?extension_uuid='.urlencode($extension_uuid)]);
			unset($button_margin);
		}
	...
	echo button::create(['type'=>'button','label'=>$text['button-save'],'icon'=>$_SESSION['theme']['button_icon_save'],'id'=>'btn_save','style'=>'','onclick'=>'submit_form();']);
	echo "	</div>\n";
	...
	if (permission_exists('extension_call_screen')) {
		...
		echo '<svg data-toggle="tooltip" data-placement="top" title="با فعال کردن این قابلیت، سامانه در تماس های ورودی، از مخاطب میخواهد که نام خود را بگوید و سپس نام رکورد شده ی مخاطب را برای داخلی پخش میکند و در صورت تایید داخلی(با کلید ۱) تماس متصل خواهد شد." width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10 0C8.02219 0 6.08879 0.58649 4.4443 1.6853C2.79981 2.78412 1.51809 4.3459 0.761209 6.17317C0.00433284 8.00043 -0.193701 10.0111 0.192152 11.9509C0.578004 13.8907 1.53041 15.6725 2.92894 17.0711C4.32746 18.4696 6.10929 19.422 8.0491 19.8079C9.98891 20.1937 11.9996 19.9957 13.8268 19.2388C15.6541 18.4819 17.2159 17.2002 18.3147 15.5557C19.4135 13.9112 20 11.9778 20 10C20 8.68678 19.7413 7.38642 19.2388 6.17317C18.7363 4.95991 17.9997 3.85752 17.0711 2.92893C16.1425 2.00035 15.0401 1.26375 13.8268 0.761205C12.6136 0.258658 11.3132 0 10 0ZM10 15.59C9.85167 15.59 9.70666 15.546 9.58333 15.4636C9.45999 15.3812 9.36386 15.2641 9.3071 15.127C9.25033 14.99 9.23548 14.8392 9.26442 14.6937C9.29335 14.5482 9.36479 14.4146 9.46968 14.3097C9.57456 14.2048 9.7082 14.1333 9.85369 14.1044C9.99917 14.0755 10.15 14.0903 10.287 14.1471C10.4241 14.2039 10.5412 14.3 10.6236 14.4233C10.706 14.5467 10.75 14.6917 10.75 14.84C10.7474 15.0381 10.6676 15.2274 10.5275 15.3675C10.3874 15.5076 10.1981 15.5874 10 15.59ZM11.36 10.36C11.1704 10.4632 11.0131 10.6169 10.9055 10.804C10.7978 10.991 10.744 11.2042 10.75 11.42V12.24C10.75 12.4389 10.671 12.6297 10.5303 12.7703C10.3897 12.911 10.1989 12.99 10 12.99C9.80109 12.99 9.61033 12.911 9.46968 12.7703C9.32902 12.6297 9.25 12.4389 9.25 12.24V11.42C9.24256 10.9204 9.37545 10.4288 9.63354 10.001C9.89164 9.57317 10.2646 9.22637 10.71 9C10.972 8.87322 11.1953 8.67861 11.3566 8.43639C11.5179 8.19416 11.6115 7.91314 11.6275 7.62254C11.6436 7.33193 11.5815 7.04234 11.4478 6.78383C11.314 6.52532 11.1135 6.30734 10.8671 6.15251C10.6206 5.99769 10.3372 5.91168 10.0463 5.90342C9.75536 5.89515 9.46752 5.96493 9.21268 6.10552C8.95783 6.2461 8.74528 6.45235 8.59709 6.70285C8.44891 6.95335 8.3705 7.23895 8.37 7.53C8.37 7.72891 8.29099 7.91968 8.15034 8.06033C8.00968 8.20098 7.81892 8.28 7.62 8.28C7.42109 8.28 7.23033 8.20098 7.08967 8.06033C6.94902 7.91968 6.87 7.72891 6.87 7.53C6.87167 7.07205 6.9735 6.62 7.16833 6.20556C7.36317 5.79111 7.6463 5.4243 7.99788 5.13084C8.34946 4.83739 8.76097 4.62438 9.20357 4.50677C9.64616 4.38916 10.1091 4.36978 10.56 4.45C11.1895 4.56842 11.7679 4.87593 12.2182 5.33153C12.6684 5.78713 12.969 6.36915 13.08 7C13.2014 7.67117 13.0988 8.36364 12.788 8.97078C12.4772 9.57792 11.9755 10.066 11.36 10.36Z" fill="#AC965E"></path>
</svg>';
		echo "</td>\n";
		echo "<td class='vtable' align='left'>\n";
