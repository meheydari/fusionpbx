<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "6b54db15-c5b7-4ada-8e70-6557695a32d7";
		...
		$apps[$x]['default_settings'][$y]['default_setting_order'] = "10";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The sms gateway endpoint used to send the authentication code.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "ed6c8fc0-dcc5-4b19-93d2-e77f463b8f94";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "sms";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "account_id";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_order'] = "20";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The account id provided by the sms gateway.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "31e6d822-0010-47f6-8c79-769be0a54466";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "sms";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "username";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_order'] = "30";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The username used to authenticate with the sms gateway (http basic auth).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "bf429cd7-53b9-43b4-98aa-e8518bc7936c";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "sms";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "password";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_order'] = "40";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The password used to authenticate with the sms gateway (http basic auth).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "e58fec3d-685d-4bc3-bf23-426dcb275071";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "sms";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "message";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_order'] = "50";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The sms text. Use \${auth_code} as a placeholder for the authentication code.";
