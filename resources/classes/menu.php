			...
			//header: right
				...
				//logout icon
					if (!empty($_SESSION['username']) && $_SESSION['theme']['logout_icon_visible']['text'] == "true") {
						$html .= "<a id='header_logout_icon' href='#' class='header-avatar' title=\"".$this->text['theme-label-logout']."\" onclick=\"modal_open('modal-logout','btn_logout');\"><span class='fas fa-sign-out-alt'></span>خروج</a>";
					}
				$html .= "</div>";
			$html .= "	</div>\n";
