...
{*//remote javascript *}
	...
	<script language='JavaScript' type='text/javascript' src='{$project_path}/resources/popper/popper.min.js.php'></script>
...
{*//web font loader *}
	{if isset($settings.theme.font_loader) && $settings.theme.font_loader == 'true'}
		{if $settings.theme.font_retrieval != 'asynchronous'}
			<script language='JavaScript' type='text/javascript' src='{$project_path}/resources/fonts/webfont.js?v={$settings.theme.font_loader_version}'></script>
		{/if}
